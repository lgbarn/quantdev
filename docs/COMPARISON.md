...
How Quantdev compares to other Claude Code project frameworks.

| Capability | Quantdev v3.0 | GSD v1.10.1 | Superpowers v3.6.2 |
|-----------|:---:|:---:|:---:|
| **Project Lifecycle** | | | |
...
| **Distribution** | | | |
| Install via CLI | ✅ (`lgbarn/quantdev`) | ✅ (`npx get-shit-done-cc`) | ✅ (marketplace) |
