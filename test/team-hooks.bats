...
teardown() {
    unset QUANTDEV_IS_TEAMMATE QUANTDEV_TEAM_NAME CLAUDE_CODE_TEAM_NAME CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS QUANTDEV_DISABLE_HOOKS QUANTDEV_SKIP_HOOKS 2>/dev/null || true
}
